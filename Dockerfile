...
RUN python -m pip install --upgrade pip setuptools wheel packaging ninja \
    ...
    && python -c "import decord, diffusers, transformers; from transformers.utils import FLAX_WEIGHTS_NAME; assert diffusers.__version__ == '0.31.0', diffusers.__version__; assert transformers.__version__ == '4.49.0', transformers.__version__; print('decord', decord.__version__, 'diffusers', diffusers.__version__, 'transformers', transformers.__version__)"
